...
class PortfolioManagerApplicationTest {
  ...
  public void testCalculateAnnualizedReturn() {
    ...
    AnnualizedReturn returns = PortfolioManagerApplication.calculateAnnualizedReturns(LocalDate.parse("2018-01-01"),
  ...
  public void testCalculateAnnualizedReturnGoogl() {
    ...
    AnnualizedReturn returns = PortfolioManagerApplication.calculateAnnualizedReturns(LocalDate.parse("2019-12-12"),
