...
class TiingoServiceTest {
    ...
    void getStockQuoteSingle() throws Exception {
        ...
        List<Candle> candles = tiingoService.getStockQuote("GOOGL", LocalDate.parse("2019-01-01"),
        ...
        Mockito.verify(restTemplate, atLeast(0)).getForObject(urlCaptorWithMap.capture(), any(), anyMap());
